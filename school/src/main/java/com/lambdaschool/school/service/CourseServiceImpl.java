...
public class CourseServiceImpl implements CourseService
{
    ...
    @Override
    public List<Course> findCourseByNameLike(String name, Pageable pageable)
    {
        List<Course> list = new ArrayList<>();
        courserepos.findByCoursenameIgnoreCase(name, pageable).iterator().forEachRemaining(list::add);
        return list;
    }
}
